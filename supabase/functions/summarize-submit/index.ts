...
출력 형식:
{"summary": "한국어 요약", "topics": ["태그", ...], "evergreen": true 또는 false}
...
- evergreen 은 **한 달 뒤에 처음 읽어도 내용이 그대로 유효한가**로 판단한다.
  - true: 개념·원리 해설, 방법·튜토리얼, 회고·경험담, 도구 비교, 분석 프레임
  - false: 사건 보도, 시황·지수, 발표·출시·인사, 실적, 특정 일자에 묶인 일정
  - 뉴스와 지식이 섞인 글(예: 신제품 출시 리뷰)은 무엇이 본문의 중심인지로 가른다 —
    출시 사실이 중심이면 false, 써 본 경험과 평가가 중심이면 true.
  - 판단이 서지 않으면 false 로 둔다.
